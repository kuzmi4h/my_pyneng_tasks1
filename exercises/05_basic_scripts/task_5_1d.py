...
param = ', '.join(london_co[device_name].keys())
parameter_name = input(f"Введите имя параметра ({param}): ").lower()
parameter_value = london_co[device_name].get(parameter_name, 'Такого параметра нет')
